  ...
  return (
    <Container onClick={()=> console.log(props)}>
               <Background key={props.key}>
                <img src={props.img[2].img} alt={props.img[2].title}></img>
            </Background>
           
            <Content>
                <ImageTitle>
                    <img src={props.img[2].imgTitle} alt=''></img>
                </ImageTitle>
                ...
                <Controls>
                    ...
                    <a href={props.img[2].trailer} target={'_blank'} rel={'noreferrer'}><TrailerBtn>
                ...
                <Subtitles>
                <p>{props.img[2].year} ‧</p> <p>{props.img[2].duration} ‧ </p> <p>{props.img[2].director} </p> 
                </Subtitles>
                <Description>
