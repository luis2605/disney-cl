  ...
  return (
    <Container onClick={()=> console.log(props)}>
               <Background key={props.key}>
                <img src={props.img[4].img} alt={props.img[4].title}></img>
            </Background>
           
            <Content>
                <ImageTitle>
                    <img src={props.img[4].imgTitle} alt=''></img>
                </ImageTitle>
                ...
                <Controls>
                    ...
                    <a href={props.img[4].trailer} target={'_blank'} rel={'noreferrer'}><TrailerBtn>
                ...
                <Subtitles>
                <p>{props.img[4].year} ‧ </p> <p> {props.img[4].duration} ‧ </p> <p>{props.img[4].director} </p> 
                </Subtitles>
                <Description>
                {props.img[4].description}
                </Description>
            </Content>
